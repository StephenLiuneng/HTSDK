...
-(void)configUIWithModel:(HTModelCenter*)model
{
    ...
    {
        self.titleLabel.text=bendihua(@"問:");
    ...
    self.detailLabel.frame=CGRectMake(50/550.0*MAINVIEW_WIDTH,15/550.0*MAINVIEW_WIDTH,self.backView.width-self.titleLabel.right,[self p_heightWithString:self.detailLabel.text]);
...
-(void)layoutSubviews
{
    ...
    self.titleLabel.frame=CGRectMake(10/550.0*MAINVIEW_WIDTH, 10/550.0*MAINVIEW_WIDTH, 40/550.0*MAINVIEW_WIDTH, 0);
    [self.titleLabel sizeToFit];
    self.detailLabel.frame=CGRectMake(self.titleLabel.right+3,15/550.0*MAINVIEW_WIDTH,self.backView.width-self.titleLabel.right-10/550.0*MAINVIEW_WIDTH,[self p_heightWithString:self.detailLabel.text]);
    self.dateLabel.centerX=self.backView.width-(self.dateLabel.width/2)-10/550.0*MAINVIEW_WIDTH;
    self.dateLabel.top=self.detailLabel.bottom+15/550.0*MAINVIEW_WIDTH;
}
