...
{
    NSURL*URL=[NSURL URLWithString:[NSString stringWithFormat:@"http://aq.gamehetu.com/%@/topic/create",[USER_DEFAULT objectForKey:@"appID"]]];
    //根据url初始化request
...
timeoutInterval:10];
    ...
    for (int i = 0; i < images.count; i++)
    {
        ...
        NSString *fileNmae = [NSString stringWithFormat:@"filename%d",i];
        //添加分界线，换行
